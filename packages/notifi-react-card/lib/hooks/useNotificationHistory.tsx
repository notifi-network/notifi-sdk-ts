...
export const useNotificationHistory = () => {
  ...
  const supportedEventDetails: SupportedEventDetailPropsMap = useMemo(() => {
    const details = new Map();

    details.set('BroadcastMessageEventDetails', {
    ...
    details.set('HealthValueOverThresholdEventDetails', {
      getViewProps: (notification: NotificationHistoryEntry) => {
        const detail =
    ...
    details.set('GenericEventDetails', {
      getViewProps: (notification: NotificationHistoryEntry) => {
    ...
    details.set('ChatMessageReceivedEventDetails', {
      getViewProps: (notification: NotificationHistoryEntry) => {
    ...
    details.set('AccountBalanceChangedEventDetails', {
      getViewProps: (notification: NotificationHistoryEntry) => {
