...
export const NotifiFooter: React.FC = () => {
  ...
  return (
    <div className={styles?.container}>
      <span className={styles?.poweredBy}>{copy?.poweredBy ?? 'Powered by'}</span>
      <NotifiLogo className={styles?.logoSvg} />
      <span className={styles?.spacer} />
      <span className={styles?.link}>
        <a href="https://docs.notifi.network/NotifiIntegrationsFAQ.html" target="_blank" rel="noopener noreferrer">
